---
title: "GsCore AI Core 插件开发者 API 文档"
description: "本文档面向插件开发者，介绍如何使用 `gsuid_core/ai_core` 模块为机器人 AI 提供工具函数、知识库和自定义 Agent 支持。"
icon: Workflow
---
...
- [触发器桥接](./trigger-bridge) - 触发器类型和 `to_ai` 参数说明
- [AI 功能概述](../) - AI Core 系统整体介绍
