---
title: "完整示例"
description: "6 个由浅入深的 AI 功能完整开发示例，覆盖权限控制、上下文等常见需求。"
icon: BookOpen
---
# 完整示例
...
更多关于 `to_ai` 参数的详细说明，请参考 [触发器文档](../code-plugins/trigger#to_ai-参数--触发器自动注册为-ai-工具)。
...
- [工具注册](./tools) - 深入了解工具注册
- [知识库注册](./knowledge-base) - 深入了解知识库
- [Agent创建](./agent) - 深入了解 Agent 创建
- [触发器文档](../code-plugins/trigger) - 深入了解触发器和 to_ai 参数
