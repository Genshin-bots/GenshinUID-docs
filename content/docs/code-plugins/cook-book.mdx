...
- 🛠 你已经通过[该文档](../started/install-core#一确认环境有无缺失)安装并检查了如下工具：
...
- 🚀 你已经通过[该教程](../started/install-core#二安装-core)安装并成功[运行](../started/install-core#三启动-core)本项目，即**GsCore正常运行**
...
示例在[这里](./plugins-data-base)，往下拉的【额外、继承Base_Model】章节中！
...
- [AI 插件编写简介](../ai-features/ai-core-api-for-plugins) — 完整的 AI API 文档
